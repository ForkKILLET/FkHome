...
ShFoldHereDoc syn region shHereDoc matchgroup=shHereDoc01 start="<<\s*\z(\(SHELL\)\@![^ \t|>]\+\)"	matchgroup=shHereDoc01 end="^\z1\s*$"	contains=@shDblQuoteList
" sh << SHELL
" echo Hack: highlight here.
" SHELL
